...
def predict_winner():
    ...
    # regression check for player rating.
        ...
        player_stats = sqlContext.read.json('file:///home/arshgoyal/Desktop/BD_Proj/full_anand/player_rating.json')
...
def player_profile():
    ...
    query = sqlContext.read.json("file:///home/arshgoyal/Desktop/BD_Proj/Evaluation_Requests/Players/inp5.json", multiLine = True)
    ...
    player_Profile = sqlContext.read.json("file:///home/arshgoyal/Desktop/BD_Proj/full_anand/player_profile.json")
...
def match_details():
    ...
    #query = sqlContext.read.json("file:///home/arshgoyal/Desktop/BD_Proj/Evaluation_Requests/Matches/inp1.json", multiLine = True)
    ...
    match_Details = sqlContext.read.json("file:///home/arshgoyal/Desktop/BD_Proj/Fully_Streamed/Match_Details.json")
